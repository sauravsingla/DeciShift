...
## 60-second real run — voice + interpretation

This demo is generated from a **fresh GitHub Actions execution** of the bundled synthetic triage DecisionFlow. The workflow runs `graph → compare → verify → gate`, then builds a narrated one-minute video from the actual command output and publishes it as a GitHub release asset.

[![Watch the DeciShift real run with voice and interpretation](https://github.com/sauravsingla/DeciShift/releases/download/v0.3.0/decishift-real-run-poster.png)](https://github.com/sauravsingla/DeciShift/releases/download/v0.3.0/decishift-real-run-with-voice.mp4)

**[▶ Watch the 60-second real run with voice + interpretation](https://github.com/sauravsingla/DeciShift/releases/download/v0.3.0/decishift-real-run-with-voice.mp4)**
...
The video is reproducible through [`Publish README demo video`](https://github.com/sauravsingla/DeciShift/actions/workflows/publish-readme-video.yml).
